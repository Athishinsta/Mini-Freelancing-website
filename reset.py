...
<body>
  ...
  <section class="forget-form">
    ...
    <p>Set strong password </p>
    <form action="login.py" method="POST" class="form">
        <label for="changepassword">Change password :</label>
        <input type="password" id="changepassword" name="changepassword" placeholder="Enter New password" required>
        <label for="confirmpassword">Confirm password :</label>
        <input type="cpassword" id="confirmpassword" name="confirmpassword" placeholder="Confirm your password" required>
